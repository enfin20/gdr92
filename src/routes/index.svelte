...
<script>
	...
	export async function updateCalendrier() {
		...
		statutSauvegarde = '    ... en cours. Ne pas fermer la fenêtre !';
...
<div class="{menuVisible} grid grid-cols-2 text-xs md:text-base bg-white w-full">
	<div />
	<div class="py-2 md:py-4 inline-block text-gray-600">
		<input
			id="soiree"
			type="date"
			bind:value={soiree}
